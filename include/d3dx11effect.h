...
DECLARE_INTERFACE_(ID3DX11EffectType, IUnknown) {
	...
	(THIS) PURE;
	STDMETHOD(GetDesc)
	(THIS_ _Out_ D3DX11_EFFECT_TYPE_DESC * pDesc) PURE;
	STDMETHOD_(ID3DX11EffectType *, GetMemberTypeByIndex)
	(THIS_ _In_ uint32_t Index) PURE;
	STDMETHOD_(ID3DX11EffectType *, GetMemberTypeByName)
	(THIS_ _In_z_ LPCSTR Name) PURE;
	STDMETHOD_(ID3DX11EffectType *, GetMemberTypeBySemantic)
	(THIS_ _In_z_ LPCSTR Semantic) PURE;
	STDMETHOD_(LPCSTR, GetMemberName)
	(THIS_ _In_ uint32_t Index) PURE;
	STDMETHOD_(LPCSTR, GetMemberSemantic)
	(THIS_ _In_ uint32_t Index) PURE;
};
...
DECLARE_INTERFACE_(ID3DX11EffectVariable, IUnknown) {
	...
	(THIS) PURE;
	STDMETHOD(GetDesc)
	(THIS_ _Out_ D3DX11_EFFECT_VARIABLE_DESC * pDesc) PURE;

	STDMETHOD_(ID3DX11EffectVariable *, GetAnnotationByIndex)
	(THIS_ _In_ uint32_t Index) PURE;
	STDMETHOD_(ID3DX11EffectVariable *, GetAnnotationByName)
	(THIS_ _In_z_ LPCSTR Name) PURE;

	STDMETHOD_(ID3DX11EffectVariable *, GetMemberByIndex)
	(THIS_ _In_ uint32_t Index) PURE;
	STDMETHOD_(ID3DX11EffectVariable *, GetMemberByName)
	(THIS_ _In_z_ LPCSTR Name) PURE;
	STDMETHOD_(ID3DX11EffectVariable *, GetMemberBySemantic)
	(THIS_ _In_z_ LPCSTR Semantic) PURE;

	STDMETHOD_(ID3DX11EffectVariable *, GetElement)
	(THIS_ _In_ uint32_t Index) PURE;
	...
	(THIS_ _In_reads_bytes_(ByteCount) const void *pData, _In_ uint32_t ByteOffset, _In_ uint32_t ByteCount) PURE;
	STDMETHOD(GetRawValue)
	(THIS_ _Out_writes_bytes_(ByteCount) void *pData, _In_ uint32_t ByteOffset, _In_ uint32_t ByteCount) PURE;
};
...
DECLARE_INTERFACE_(ID3DX11EffectScalarVariable, ID3DX11EffectVariable) {
	...
	// ID3DX11EffectScalarVariable
	STDMETHOD(SetFloat)
	(THIS_ _In_ const float Value) PURE;
	STDMETHOD(GetFloat)
	(THIS_ _Out_ float *pValue) PURE;

	STDMETHOD(SetFloatArray)
	(THIS_ _In_reads_(Count) const float *pData, _In_ uint32_t Offset, _In_ uint32_t Count) PURE;
	STDMETHOD(GetFloatArray)
	(THIS_ _Out_writes_(Count) float *pData, _In_ uint32_t Offset, _In_ uint32_t Count) PURE;

	STDMETHOD(SetInt)
	(THIS_ _In_ const int Value) PURE;
	STDMETHOD(GetInt)
	(THIS_ _Out_ int *pValue) PURE;

	STDMETHOD(SetIntArray)
	(THIS_ _In_reads_(Count) const int *pData, _In_ uint32_t Offset, _In_ uint32_t Count) PURE;
	STDMETHOD(GetIntArray)
	(THIS_ _Out_writes_(Count) int *pData, _In_ uint32_t Offset, _In_ uint32_t Count) PURE;

	STDMETHOD(SetBool)
	(THIS_ _In_ const bool Value) PURE;
	STDMETHOD(GetBool)
	(THIS_ _Out_ bool *pValue) PURE;

	STDMETHOD(SetBoolArray)
	(THIS_ _In_reads_(Count) const bool *pData, _In_ uint32_t Offset, _In_ uint32_t Count) PURE;
	STDMETHOD(GetBoolArray)
	(THIS_ _Out_writes_(Count) bool *pData, _In_ uint32_t Offset, _In_ uint32_t Count) PURE;
};
...
DECLARE_INTERFACE_(ID3DX11EffectVectorVariable, ID3DX11EffectVariable) {
	...
	// ID3DX11EffectVectorVariable
	STDMETHOD(SetBoolVector)
	(THIS_ _In_reads_(4) const bool *pData) PURE;
	STDMETHOD(SetIntVector)
	(THIS_ _In_reads_(4) const int *pData) PURE;
	STDMETHOD(SetFloatVector)
	(THIS_ _In_reads_(4) const float *pData) PURE;

	STDMETHOD(GetBoolVector)
	(THIS_ _Out_writes_(4) bool *pData) PURE;
	STDMETHOD(GetIntVector)
	(THIS_ _Out_writes_(4) int *pData) PURE;
	STDMETHOD(GetFloatVector)
	(THIS_ _Out_writes_(4) float *pData) PURE;

	STDMETHOD(SetBoolVectorArray)
	(THIS_ _In_reads_(Count * 4) const bool *pData, _In_ uint32_t Offset, _In_ uint32_t Count) PURE;
	STDMETHOD(SetIntVectorArray)
	(THIS_ _In_reads_(Count * 4) const int *pData, _In_ uint32_t Offset, _In_ uint32_t Count) PURE;
	STDMETHOD(SetFloatVectorArray)
	(THIS_ _In_reads_(Count * 4) const float *pData, _In_ uint32_t Offset, _In_ uint32_t Count) PURE;

	STDMETHOD(GetBoolVectorArray)
	(THIS_ _Out_writes_(Count * 4) bool *pData, _In_ uint32_t Offset, _In_ uint32_t Count) PURE;
	STDMETHOD(GetIntVectorArray)
	(THIS_ _Out_writes_(Count * 4) int *pData, _In_ uint32_t Offset, _In_ uint32_t Count) PURE;
	STDMETHOD(GetFloatVectorArray)
	(THIS_ _Out_writes_(Count * 4) float *pData, _In_ uint32_t Offset, _In_ uint32_t Count) PURE;
};
...
DECLARE_INTERFACE_(ID3DX11EffectMatrixVariable, ID3DX11EffectVariable) {
	...
	// ID3DX11EffectMatrixVariable
	STDMETHOD(SetMatrix)
	(THIS_ _In_reads_(16) const float *pData) PURE;
	STDMETHOD(GetMatrix)
	(THIS_ _Out_writes_(16) float *pData) PURE;

	STDMETHOD(SetMatrixArray)
	(THIS_ _In_reads_(Count * 16) const float *pData, _In_ uint32_t Offset, _In_ uint32_t Count) PURE;
	STDMETHOD(GetMatrixArray)
	(THIS_ _Out_writes_(Count * 16) float *pData, _In_ uint32_t Offset, _In_ uint32_t Count) PURE;

	STDMETHOD(SetMatrixPointerArray)
	(_In_reads_(Count * 16) const float **ppData, uint32_t Offset, uint32_t Count) PURE;
	STDMETHOD(GetMatrixPointerArray)
	(_Out_writes_(Count * 16) float **ppData, uint32_t Offset, uint32_t Count) PURE;
...
DECLARE_INTERFACE_(ID3DX11EffectStringVariable, ID3DX11EffectVariable) {
	...
	// ID3DX11EffectStringVariable
	STDMETHOD(GetString)
	(THIS_ _Outptr_result_z_ LPCSTR * ppString) PURE;
	STDMETHOD(GetStringArray)
	(THIS_ _Out_writes_(Count) LPCSTR * ppStrings, _In_ uint32_t Offset, _In_ uint32_t Count) PURE;
};
...
DECLARE_INTERFACE_(ID3DX11EffectClassInstanceVariable, ID3DX11EffectVariable) {
	...
	// ID3DX11EffectClassInstanceVariable
	STDMETHOD(GetClassInstance)
	(_Outptr_ ID3D11ClassInstance * *ppClassInstance) PURE;
};
...
DECLARE_INTERFACE_(ID3DX11EffectInterfaceVariable, ID3DX11EffectVariable) {
	...
	// ID3DX11EffectInterfaceVariable
	STDMETHOD(SetClassInstance)
	(_In_ ID3DX11EffectClassInstanceVariable * pEffectClassInstance) PURE;
	STDMETHOD(GetClassInstance)
	(_Outptr_ ID3DX11EffectClassInstanceVariable * *ppEffectClassInstance) PURE;
};
...
DECLARE_INTERFACE_(ID3DX11EffectShaderResourceVariable, ID3DX11EffectVariable) {
	...
	(THIS_ _In_ ID3D11ShaderResourceView * pResource) PURE;
	STDMETHOD(GetResource)
	(THIS_ _Outptr_ ID3D11ShaderResourceView * *ppResource) PURE;

	STDMETHOD(SetResourceArray)
	(THIS_ _In_reads_(Count) ID3D11ShaderResourceView * *ppResources, _In_ uint32_t Offset, _In_ uint32_t Count) PURE;
	STDMETHOD(GetResourceArray)
	(THIS_ _Out_writes_(Count) ID3D11ShaderResourceView * *ppResources, _In_ uint32_t Offset, _In_ uint32_t Count) PURE;
};
...
DECLARE_INTERFACE_(ID3DX11EffectUnorderedAccessViewVariable, ID3DX11EffectVariable) {
	...
	// ID3DX11EffectUnorderedAccessViewVariable
	STDMETHOD(SetUnorderedAccessView)
	(THIS_ _In_ ID3D11UnorderedAccessView * pResource) PURE;
	STDMETHOD(GetUnorderedAccessView)
	(THIS_ _Outptr_ ID3D11UnorderedAccessView * *ppResource) PURE;

	STDMETHOD(SetUnorderedAccessViewArray)
	(THIS_ _In_reads_(Count) ID3D11UnorderedAccessView * *ppResources, _In_ uint32_t Offset, _In_ uint32_t Count) PURE;
	STDMETHOD(GetUnorderedAccessViewArray)
	(THIS_ _Out_writes_(Count) ID3D11UnorderedAccessView * *ppResources, _In_ uint32_t Offset, _In_ uint32_t Count) PURE;
};
...
DECLARE_INTERFACE_(ID3DX11EffectRenderTargetViewVariable, ID3DX11EffectVariable) {
	...
	(THIS_ _In_ ID3D11RenderTargetView * pResource) PURE;
	STDMETHOD(GetRenderTarget)
	(THIS_ _Outptr_ ID3D11RenderTargetView * *ppResource) PURE;

	STDMETHOD(SetRenderTargetArray)
	(THIS_ _In_reads_(Count) ID3D11RenderTargetView * *ppResources, _In_ uint32_t Offset, _In_ uint32_t Count) PURE;
	STDMETHOD(GetRenderTargetArray)
	(THIS_ _Out_writes_(Count) ID3D11RenderTargetView * *ppResources, _In_ uint32_t Offset, _In_ uint32_t Count) PURE;
};
...
DECLARE_INTERFACE_(ID3DX11EffectDepthStencilViewVariable, ID3DX11EffectVariable) {
	...
	// ID3DX11EffectDepthStencilViewVariable
	STDMETHOD(SetDepthStencil)
	(THIS_ _In_ ID3D11DepthStencilView * pResource) PURE;
	STDMETHOD(GetDepthStencil)
	(THIS_ _Outptr_ ID3D11DepthStencilView * *ppResource) PURE;

	STDMETHOD(SetDepthStencilArray)
	(THIS_ _In_reads_(Count) ID3D11DepthStencilView * *ppResources, _In_ uint32_t Offset, _In_ uint32_t Count) PURE;
	STDMETHOD(GetDepthStencilArray)
	(THIS_ _Out_writes_(Count) ID3D11DepthStencilView * *ppResources, _In_ uint32_t Offset, _In_ uint32_t Count) PURE;
};
...
DECLARE_INTERFACE_(ID3DX11EffectConstantBuffer, ID3DX11EffectVariable) {
	...
	// ID3DX11EffectConstantBuffer
	STDMETHOD(SetConstantBuffer)
	(THIS_ _In_ ID3D11Buffer * pConstantBuffer) PURE;
	STDMETHOD(UndoSetConstantBuffer)
	(THIS) PURE;
	STDMETHOD(GetConstantBuffer)
	(THIS_ _Outptr_ ID3D11Buffer * *ppConstantBuffer) PURE;

	STDMETHOD(SetTextureBuffer)
	(THIS_ _In_ ID3D11ShaderResourceView * pTextureBuffer) PURE;
	STDMETHOD(UndoSetTextureBuffer)
	(THIS) PURE;
	STDMETHOD(GetTextureBuffer)
	(THIS_ _Outptr_ ID3D11ShaderResourceView * *ppTextureBuffer) PURE;
};
...
DECLARE_INTERFACE_(ID3DX11EffectShaderVariable, ID3DX11EffectVariable) {
	...
	(THIS_ _In_ uint32_t ShaderIndex, _Outptr_ ID3D11VertexShader * *ppVS) PURE;
	STDMETHOD(GetGeometryShader)
	(THIS_ _In_ uint32_t ShaderIndex, _Outptr_ ID3D11GeometryShader * *ppGS) PURE;
	STDMETHOD(GetPixelShader)
	(THIS_ _In_ uint32_t ShaderIndex, _Outptr_ ID3D11PixelShader * *ppPS) PURE;
	STDMETHOD(GetHullShader)
	(THIS_ _In_ uint32_t ShaderIndex, _Outptr_ ID3D11HullShader * *ppHS) PURE;
	STDMETHOD(GetDomainShader)
	(THIS_ _In_ uint32_t ShaderIndex, _Outptr_ ID3D11DomainShader * *ppDS) PURE;
	STDMETHOD(GetComputeShader)
	(THIS_ _In_ uint32_t ShaderIndex, _Outptr_ ID3D11ComputeShader * *ppCS) PURE;

	STDMETHOD(GetInputSignatureElementDesc)
	(THIS_ _In_ uint32_t ShaderIndex, _In_ uint32_t Element, _Out_ D3D11_SIGNATURE_PARAMETER_DESC * pDesc) PURE;
...
DECLARE_INTERFACE_(ID3DX11EffectBlendVariable, ID3DX11EffectVariable) {
	...
	(THIS_ _In_ uint32_t Index, _Outptr_ ID3D11BlendState * *ppState) PURE;
	STDMETHOD(SetBlendState)
	(THIS_ _In_ uint32_t Index, _In_ ID3D11BlendState * pState) PURE;
	STDMETHOD(UndoSetBlendState)
	(THIS_ _In_ uint32_t Index) PURE;
	STDMETHOD(GetBackingStore)
	(THIS_ _In_ uint32_t Index, _Out_ D3D11_BLEND_DESC * pDesc) PURE;
};
...
DECLARE_INTERFACE_(ID3DX11EffectDepthStencilVariable, ID3DX11EffectVariable) {
	...
	(THIS_ _In_ uint32_t Index, _Outptr_ ID3D11DepthStencilState * *ppState) PURE;
	STDMETHOD(SetDepthStencilState)
	(THIS_ _In_ uint32_t Index, _In_ ID3D11DepthStencilState * pState) PURE;
	STDMETHOD(UndoSetDepthStencilState)
	(THIS_ _In_ uint32_t Index) PURE;
	STDMETHOD(GetBackingStore)
	(THIS_ _In_ uint32_t Index, _Out_ D3D11_DEPTH_STENCIL_DESC * pDesc) PURE;
};
...
DECLARE_INTERFACE_(ID3DX11EffectRasterizerVariable, ID3DX11EffectVariable) {
	...
	(THIS_ _In_ uint32_t Index, _Outptr_ ID3D11RasterizerState * *ppState) PURE;
	STDMETHOD(SetRasterizerState)
	(THIS_ _In_ uint32_t Index, _In_ ID3D11RasterizerState * pState) PURE;
	STDMETHOD(UndoSetRasterizerState)
	(THIS_ _In_ uint32_t Index) PURE;
	STDMETHOD(GetBackingStore)
	(THIS_ _In_ uint32_t Index, _Out_ D3D11_RASTERIZER_DESC * pDesc) PURE;
};
...
DECLARE_INTERFACE_(ID3DX11EffectSamplerVariable, ID3DX11EffectVariable) {
	...
	// ID3DX11EffectSamplerVariable
	STDMETHOD(GetSampler)
	(THIS_ _In_ uint32_t Index, _Outptr_ ID3D11SamplerState * *ppSampler) PURE;
	STDMETHOD(SetSampler)
	(THIS_ _In_ uint32_t Index, _In_ ID3D11SamplerState * pSampler) PURE;
	STDMETHOD(UndoSetSampler)
	(THIS_ _In_ uint32_t Index) PURE;
	STDMETHOD(GetBackingStore)
	(THIS_ _In_ uint32_t Index, _Out_ D3D11_SAMPLER_DESC * pDesc) PURE;
};
...
DECLARE_INTERFACE_(ID3DX11EffectPass, IUnknown) {
	...
	(THIS) PURE;
	STDMETHOD(GetDesc)
	(THIS_ _Out_ D3DX11_PASS_DESC * pDesc) PURE;

	STDMETHOD(GetVertexShaderDesc)
	(THIS_ _Out_ D3DX11_PASS_SHADER_DESC * pDesc) PURE;
	STDMETHOD(GetGeometryShaderDesc)
	(THIS_ _Out_ D3DX11_PASS_SHADER_DESC * pDesc) PURE;
	STDMETHOD(GetPixelShaderDesc)
	(THIS_ _Out_ D3DX11_PASS_SHADER_DESC * pDesc) PURE;
	STDMETHOD(GetHullShaderDesc)
	(THIS_ _Out_ D3DX11_PASS_SHADER_DESC * pDesc) PURE;
	STDMETHOD(GetDomainShaderDesc)
	(THIS_ _Out_ D3DX11_PASS_SHADER_DESC * pDesc) PURE;
	STDMETHOD(GetComputeShaderDesc)
	(THIS_ _Out_ D3DX11_PASS_SHADER_DESC * pDesc) PURE;
	...
	STDMETHOD(Apply)
	(THIS_ _In_ uint32_t Flags, _In_ ID3D11DeviceContext * pContext) PURE;

	STDMETHOD(ComputeStateBlockMask)
	(THIS_ _Inout_ D3DX11_STATE_BLOCK_MASK * pStateBlockMask) PURE;
};
...
DECLARE_INTERFACE_(ID3DX11EffectTechnique, IUnknown) {
	...
	(THIS) PURE;
	STDMETHOD(GetDesc)
	(THIS_ _Out_ D3DX11_TECHNIQUE_DESC * pDesc) PURE;
	...
	STDMETHOD_(ID3DX11EffectPass *, GetPassByIndex)
	(THIS_ _In_ uint32_t Index) PURE;
	STDMETHOD_(ID3DX11EffectPass *, GetPassByName)
	(THIS_ _In_z_ LPCSTR Name) PURE;
...
DECLARE_INTERFACE_(ID3DX11EffectGroup, IUnknown) {
	...
	(THIS) PURE;
	STDMETHOD(GetDesc)
	(THIS_ _Out_ D3DX11_GROUP_DESC * pDesc) PURE;
	...
	STDMETHOD_(ID3DX11EffectTechnique *, GetTechniqueByIndex)
	(THIS_ _In_ uint32_t Index) PURE;
	STDMETHOD_(ID3DX11EffectTechnique *, GetTechniqueByName)
	(THIS_ _In_z_ LPCSTR Name) PURE;
};
...
DECLARE_INTERFACE_(ID3DX11Effect, IUnknown) {
	...
	STDMETHOD(GetDevice)
	(THIS_ _Outptr_ ID3D11Device * *ppDevice) PURE;

	STDMETHOD(GetDesc)
	(THIS_ _Out_ D3DX11_EFFECT_DESC * pDesc) PURE;

	STDMETHOD_(ID3DX11EffectConstantBuffer *, GetConstantBufferByIndex)
	(THIS_ _In_ uint32_t Index) PURE;
	STDMETHOD_(ID3DX11EffectConstantBuffer *, GetConstantBufferByName)
	(THIS_ _In_z_ LPCSTR Name) PURE;

	STDMETHOD_(ID3DX11EffectVariable *, GetVariableByIndex)
	(THIS_ _In_ uint32_t Index) PURE;
	STDMETHOD_(ID3DX11EffectVariable *, GetVariableByName)
	(THIS_ _In_z_ LPCSTR Name) PURE;
	STDMETHOD_(ID3DX11EffectVariable *, GetVariableBySemantic)
	(THIS_ _In_z_ LPCSTR Semantic) PURE;

	STDMETHOD_(ID3DX11EffectGroup *, GetGroupByIndex)
	(THIS_ _In_ uint32_t Index) PURE;
	STDMETHOD_(ID3DX11EffectGroup *, GetGroupByName)
	(THIS_ _In_z_ LPCSTR Name) PURE;
	...
	(THIS_ _In_ uint32_t Flags, _Outptr_ ID3DX11Effect * *ppClonedEffect) PURE;
	STDMETHOD(Optimize)
	(THIS) PURE;
