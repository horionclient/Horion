#include "AutoStaircase1.h"

AutoStaircase::AutoStaircase() : IModule(0, Category::WORLD, "Builds a staircase going down when you walk.") {
}

AutoStaircase::~AutoStaircase() {
}

const char* AutoStaircase::getModuleName() {
	return "Auto Staircase";
}


//This module is a modified version of scaffold, made to place a block 1 and 2 blocks below the player to create a staircase that decends when the player walks.


//from scaffold:

bool AutoStaircase::tryScaffold(vec3_t blockBelow) {
...
void AutoStaircase::onTick(C_GameMode* gm) {
