...
void C_ContainerScreenController::handleAutoPlace(uintptr_t a1, std::string name, int slot) {
	...
	static ContainerScreenController__autoPlace autoPlaceFunc = reinterpret_cast<ContainerScreenController__autoPlace>(FindSignature("40 55 53 56 57 41 54 41 55 41 56 41 57 48 8D 6C 24 E1 48 81 EC F8 00 00 00 48 C7 44 24 58 FE FF FF FF 48 8B 05 E7 90 CA 00 48 33 C4 48 89 45 07 4D 8B F9 4D 8B E8"));
