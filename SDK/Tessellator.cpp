...
__int64 BlockTessellator::getMeshForBlockInWorld(Tessellator *t, C_Block *block, vec3_ti &pos) {
	using BT_getMeshForBlockInWorld_t = __int64 (*)(BlockTessellator *, Tessellator *, C_Block *, vec3_ti &, int, __int64);
