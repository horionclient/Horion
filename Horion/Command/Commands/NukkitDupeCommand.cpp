#include "NukkitDupeCommand.h"

NukkitDupeCommand::NukkitDupeCommand() : IMCCommand("nukkitdupe", "Dupe for nukkit servers!", "") {
	registerAlias("ndupe");
} 


NukkitDupeCommand::~NukkitDupeCommand() {
}

bool NukkitDupeCommand::execute(std::vector<std::string>* args) {
